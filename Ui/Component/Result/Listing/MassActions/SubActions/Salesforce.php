...
namespace MageMe\WebFormsSalesforce\Ui\Component\Result\Listing\MassActions\SubActions;
...
class Salesforce extends Action
{
    ...
    {
        return [
            'type' => 'salesforce_send_submission',
            'label' => __('Send Lead'),
            'url' => $this->urlBuilder->getUrl(
                'webformssalesforce/result/ajaxSendSubmission'
            ),
            'isAjax' => true,
            'confirm' => [
                'title' => __('Send Lead'),
    ...
    protected function isDisabled(): bool
    {
        ...
        try {
            ...
            /** @var \MageMe\WebFormsSalesforce\Api\Data\FormInterface $form */
            $form = $this->formRepository->getById($formId);
            if (!$form->getIsSalesforceEnabled()) {
                return true;
            }

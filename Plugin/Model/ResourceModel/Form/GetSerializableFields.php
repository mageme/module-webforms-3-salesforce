...
namespace MageMe\WebFormsSalesforce\Plugin\Model\ResourceModel\Form;
...
class GetSerializableFields
{
    ...
    {
        $serializableFields[FormInterface::SALESFORCE_MAP_FIELDS] = [
            $form::SERIALIZE_OPTION_SERIALIZED => FormInterface::SALESFORCE_MAP_FIELDS_SERIALIZED,
